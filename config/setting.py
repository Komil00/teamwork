...
MIGRATION_MODULES = {"sites": "teamwork.contrib.sites.migrations"}
...
AUTHENTICATION_BACKENDS = [
    ...
    "teamwork.users.backend.CustomBackend",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "teamwork.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "teamwork.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "teamwork.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
...
SECRET_KEY = env(
    "DJANGO_SECRET_KEY",
    default="KVK0XCdaDMIyT6ycwQ8iztnuZbVVqvq2y8X11YwMDtTWU3oQfZxVBSaOj9ex7Iwo",
)
